  ...
  return (
    <>
      {loading ? (
        ...
        <div className="tabla-platillos-container">
            ...
            <tbody>
              {platillos.map((platillo) => {
                const categoria = categorias.find(
                  (cat) => cat.id_categoria === platillo.categoria_platillo
                );
                return (
                  <tr key={platillo.id_platillo}>
                    ...
                    {/* Celda de descripción con truncado y tooltip */}
                    <td className="celda-descripcion" title={platillo.descripcion}>
                    ...
                    <td className="text-center">
                      <img
                        src={
                          platillo.url_imagen || "https://via.placeholder.com/50"
                        }
